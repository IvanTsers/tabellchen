...
#+end_src
#+begin_export latex
\subsection{Function \texttt{GetCol}}
!The function \texttt{GetCol} retrieves the specified column from a
!table.
...
#+end_src
#+begin_export latex
\subsection{Function \texttt{ColUnique}}
!The function \tetxttt{ColUnique} returns unique values found in a
!column.
